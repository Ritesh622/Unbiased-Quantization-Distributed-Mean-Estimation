...
def get_f_MNIST(data_path: str = "./data"):
    # Load Fashion MNIST dataset and apply normalization
...
centralized_filename = "centralized_accuracy_DRIVE_results.pkl"
...
distributed_filename = "distributed_accuracy_DRIVE_results.pkl"
