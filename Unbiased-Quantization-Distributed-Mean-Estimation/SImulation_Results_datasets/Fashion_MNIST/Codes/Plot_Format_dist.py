...
def plot_accuracy_distributed(pkl_file_paths, filename):
...
if __name__ =="__main__": 
    ...
    # Call the function with all found .pkl files
    plot_accuracy_distributed(pkl_files, "distributed_f_MNIST")
