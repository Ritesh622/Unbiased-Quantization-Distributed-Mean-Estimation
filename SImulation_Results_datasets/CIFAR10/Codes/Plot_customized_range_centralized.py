...
def plot_accuracy_centralized_custom(pkl_file_paths, filename, start_round=None, end_round=None):
...
if __name__ == "__main__": 
    ...
    plot_accuracy_centralized_custom(pkl_files, "centralized_CIFAR10_custom", start_round=250, end_round=300)
