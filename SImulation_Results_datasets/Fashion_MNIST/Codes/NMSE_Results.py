...
import numpy as np
import pandas as pd
import torch  # added to check for torch tensors
...
def compute_nmse_stats_auto(parent_folder: str, sampled_clients_per_round: int = 5):
    ...
    excel_filename = "NMSE_stats_F_MNIST.xlsx"
    df.to_excel(excel_filename, index=False, engine="openpyxl")
    print(f"NMSE statistics saved in: {excel_filename}")

if __name__ == "__main__":
    parent_folder_path = "/home/ritesh/Ritesh/WorkWithNithish/AISTATS2025/Fashion_MNIST/Codes/NMSE_Results_f_MNIST"
