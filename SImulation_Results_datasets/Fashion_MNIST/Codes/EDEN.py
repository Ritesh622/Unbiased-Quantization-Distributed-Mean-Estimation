...
# DATASET PREPARATION
# =============================================================================
def get_f_MNIST(data_path: str = "./data"):
    tr = Compose([ToTensor(), Normalize((0.5,), (0.5,))])  # Adjusted for grayscale images
...
# =============================================================================
dir = os.getcwd()
files_dir = os.path.join(dir, 'Simulation_results_f_MNIST')
os.makedirs(files_dir, exist_ok=True)

# =============================================================================
# DIRECTORY SETUP FOR TIMING LOGGING
# =============================================================================
files_dir_time = os.path.join(dir, 'Simulation_timing_f_MNIST')
...
# =============================================================================
# MAIN SIMULATION LOOP FOR EDEN_quantize_Hadamard SCHEME
# =============================================================================
...
for quantization_func in quantization_schemes:
    ...
    for bits_per_dimension in current_bit_depths:
        ...
        print("="*20)
        time_to_save = (end_time - start_time) / 60
        log_simulation_time(quantization_scheme_name, bits_per_dimension, elapsed_minutes)
        #log_simulation_time(quantization_scheme_name, bits_per_dimension, time_to_save)
        #  ================= time logging - end=================================
        ...
        #print(f"{Fore.YELLOW}Finished {quantization_scheme_name} with {bits_per_dimension} bits in {time_to_save:.2f} min.{Style.RESET_ALL}")
